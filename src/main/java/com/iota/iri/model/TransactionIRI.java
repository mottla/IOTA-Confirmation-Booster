 ...
 */
public class TransactionIRI implements Persistable {
    ...
    public byte[] metadata() {
        int allocateSize
                = Hash.SIZE_IN_BYTES * 6
                + //address,bundle,trunk,branch,obsoleteTag,tag
                Long.BYTES * 9
                + //value,currentIndex,lastIndex,timestamp,attachmentTimestampLowerBound,attachmentTimestampUpperBound,arrivalTime,height
                Integer.BYTES * 3
                + //validity,type,snapshot
                1
                + //solid
    ...
    public void print() {
        ...
        System.out.println("obsoleteTag " + obsoleteTag.toString());
