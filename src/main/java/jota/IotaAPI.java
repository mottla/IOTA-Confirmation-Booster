...
import java.util.*;
import theman.Builder;

/**
 * IotaAPI Builder. Usage:
 * <p>
 * IotaApiProxy api = IotaApiProxy.Builder .protocol("http")
 * .nodeAddress("localhost") .port(12345) .build();
 * <p>
 * GetNodeInfoResponse response = api.getNodeInfo();
 *
 * @author davassi
 */
public abstract class IotaAPI extends IotaAPICore {
     ...
     * This is either done deterministically, or by providing the index of the
     * new remainderAddress.
     *
     * @param seed Tryte-encoded seed. It should be noted that this seed is not
     * transferred.
     * @param security Security level to be used for the private key / address.
     * Can be 1, 2 or 3.
     * @param index Key index to start search from. If the index is provided,
     * the generation of the address is not deterministic.
     * @param checksum Adds 9-tryte address checksum.
     * @param total Total number of addresses to generate.
     * @param returnAll If <code>true</code>, it returns all addresses which
     * were deterministically generated (until findTransactions returns null).
     ...
     * @param inclusionStates If <code>true</code>, it gets the inclusion states
     * of the transfers.
     * @return Bundle of transfers.
     * @throws InvalidAddressException is thrown when the specified address is
     * not an valid address.
     * @throws ArgumentException is thrown when an invalid argument is provided.
     * @throws InvalidBundleException is thrown if an invalid bundle was found
     * or provided.
     * @throws InvalidSignatureException is thrown when an invalid signature is
     * encountered.
     * @throws NoNodeInfoException is thrown when its not possible to get node
     * info.
     * @throws NoInclusionStatesException when it not possible to get a
     * inclusion state.
     * @throws InvalidSecurityLevelException is thrown when the specified
     * security level is not valid.
     */
     ...
     * @throws BroadcastAndStoreException is thrown if its not possible to
     * broadcast and store.
     */
    ...
    /**
     * Facade method: Gets transactions to approve, attaches to Tangle,
    ...
    /**
     * Wrapper function for getTrytes and transactionObjects. Gets the trytes
     * and transaction object from a list of transaction hashes.
     *
     ...
     * Returns the transactionObject of a transaction hash. The input can be a
     * valid findTransactions input.
     *
     ...
     * @return an array of bundle, if there are multiple arrays it means that
     * there are conflicting bundles.
     * @throws ArgumentException is thrown when an invalid argument is provided.
     * @throws InvalidBundleException is thrown if an invalid bundle was found
     * or provided.
     * @throws InvalidSignatureException is thrown when an invalid signature is
     ...
     * @throws InvalidAddressException is thrown when the specified address is
     * not an valid address.
     * @throws NoInclusionStatesException is thrown when it not possible to get
     * a inclusion state.
     * @throws NoNodeInfoException is thrown when its not possible to get node
     * info.
     */
    ...
    /**
     * Wrapper function that basically does prepareTransfers, as well as
     * attachToTangle and finally, it broadcasts and stores the transactions
     * locally.
     *
     ...
     * @param remainderAddress If defined, this remainderAddress will be used
     * for sending the remainder value (of the inputs) to.
     * @return Array of Transaction objects.
     * @throws InvalidAddressException is thrown when the specified
     * remainderAddress is not an valid remainderAddress.
     * @throws NotEnoughBalanceException is thrown when a transfer fails because
     * their is not enough balance to perform the transfer.
     * @throws InvalidSecurityLevelException is thrown when the specified
     * security level is not valid.
     ...
     * the bundle hash of the transaction is no longer the same. In case the
     * input transaction hash is not a tail, we return an error.
     *
    ...
    /**
     * Prepares transfer by generating the bundle with the corresponding
     * cosigner transactions. Does not contain signatures.
     *
     ...
     * @param remainderAddress Has to be generated by the cosigners before
     * initiating the transfer, can be null if fully spent.
     ...
     * @param remainderAddress If defined, this address will be used for sending
     * the remainder value (of the inputs) to.
    ...
    // removed this pattern... i didnt like it.. use my own builder instead and pass it as cunstructor argument
    // like every fucking normal programmer! fuck you 
